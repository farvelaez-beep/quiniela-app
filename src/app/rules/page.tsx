...
import { ArrowLeft, Trophy, Target, Crown, Calendar, DollarSign, ShieldCheck, Lock, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Section icon={<Trophy className="w-5 h-5"/>} title="Cómo jugar">
          <ol className="list-decimal list-inside space-y-2 text-zinc-300">
            <li><strong className="text-white">Regístrate</strong> con tu email y crea una cuenta. Confirma tu email cuando llegue el correo.</li>
            <li><strong className="text-white">Paga la cuota de entrada</strong> al organizador (por Nequi, Daviplata, transferencia o efectivo).</li>
            <li><strong className="text-white">Pronostica los 72 partidos</strong> de la fase de grupos. Pones tu predicción de marcador (ej: Argentina 2 - Colombia 1).</li>
            <li><strong className="text-white">Elige al goleador del torneo</strong> (Bota de Oro) y al país <strong>campeón</strong>.</li>
            <li>El <strong className="text-white">11 de junio</strong> arranca el Mundial. Los pronósticos se cierran automáticamente y el organizador empezará a cargar los resultados oficiales después de cada partido.</li>
            <li>Tu posición en la <strong className="text-white">Tabla</strong> se actualiza en tiempo real con cada resultado cargado.</li>
          </ol>
        </Section>
        ...
        <Section icon={<Target className="w-5 h-5"/>} title="Sistema de puntos">
          ...
          <p className="text-xs text-zinc-500 mt-4">
            En empate: pronosticaste cualquier empate (1-1, 0-0, 2-2…) y el partido terminó en empate → 1 punto. Si el resultado es exacto al pronóstico → 3 puntos.
          </p>
        </Section>
        ...
        <Section icon={<Calendar className="w-5 h-5"/>} title="Fechas importantes">
          <ul className="space-y-2 text-zinc-300">
            ...
            <li><span className="text-zinc-500">Anuncio del ganador:</span> <strong className="text-white">20 de julio de 2026</strong></li>
          </ul>
        </Section>

        {/* SECCIÓN 4: Premio */}
        <Section icon={<DollarSign className="w-5 h-5"/>} title="Premio">
          <div className="bg-zinc-900 border border-lime-400/30 rounded-lg p-5">
            <p className="text-zinc-300 mb-3">
              El <strong className="text-lime-400">primer lugar</strong> de la tabla se lleva el <strong className="text-white">100% del pozo</strong> (suma de todas las cuotas de entrada de los jugadores que pagaron).
            </p>
            <p className="text-xs text-zinc-500">
              En caso de empate en puntos, gana quien tenga más marcadores exactos. Si persiste el empate, se reparte el premio.
            </p>
          </div>
          <p className="text-sm text-zinc-400 mt-3">
            <strong>Ejemplo:</strong> 20 jugadores pagaron 20.000 COP cada uno → el ganador se lleva <strong className="text-lime-400">400.000 COP</strong>.
          </p>
        </Section>

        {/* SECCIÓN 5: Reglas justas */}
        ...
        <Section icon={<Lock className="w-5 h-5"/>} title="Privacidad">
          <p className="text-zinc-300 text-sm">
            Tu email solo se usa para confirmar tu cuenta y enviar notificaciones de la quiniela. No se comparte con terceros. Los demás jugadores solo ven tu nombre en la tabla, no tu correo.
          </p>
        </Section>
